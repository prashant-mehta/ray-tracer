...
src/%.o: ../src/%.cpp
	...
	g++ -std=c++0x -I"/home/prashantm/repo/CS410/PA4/include" -O3 -g3 -ftest-coverage -fprofile-arcs -c -fmessage-length=0 -Wsign-compare -std=c++11 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
