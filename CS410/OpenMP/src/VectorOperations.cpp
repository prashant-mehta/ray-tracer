...
float * VectorOperations::SolveForIntersection(Vertex L, Vertex A, Vertex B, Vertex C, Vertex U, bool &no_solution) {
	...
	bool deteminant_zero = false;

	this->matrix_operations->Determinant(rhs, deteminant_zero);
