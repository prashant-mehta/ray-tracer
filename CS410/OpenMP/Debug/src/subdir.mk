...
src/%.o: ../src/%.cpp
	...
	g++ -std=c++0x -I"/home/prashantm/ray-tracer/CS410/OpenMP/include" -O3 -g3 -ftest-coverage -fprofile-arcs -c -fmessage-length=0 -Wsign-compare -std=c++11 -fopenmp -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
